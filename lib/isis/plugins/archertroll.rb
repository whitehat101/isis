...
class Isis::Plugin::ArcherTroll < Isis::Plugin::Base
  ...
  QUOTES = {
    ...
    "\"Holy shitsnacks!\" -- Pam Poovey" => "http://i.imgur.com/b7OXp.jpg",
    ...
    "\"Keep that tramp date of yours out of my medicine cabinet! One more dead body in here and that bitch Trudy Beekman will have me right back in front of the Co-op Board!\" -- Malory Archer" => "http://www.scrubs123.com/blog/wp-content/uploads/2011/01/medicine-cabinet_59x73.5_we.jpg",
