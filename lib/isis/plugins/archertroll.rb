...
class Isis::Plugin::ArcherTroll < Isis::Plugin::Base
  ...
  QUOTES = {
    ...
    "\"Holy sh*tsnacks!\" -- Pam Poovey" => "http://i.imgur.com/47ZJoFR.jpg",
    ...
    "\"And thanks Pam. Way to drag out a kidnapping. Now I'm late again. But this is a way better excuse than the train dwarf. Yuck.\" -- Cheryl Tunt" => "http://media-cache-ec4.pinterest.com/upload/224335625159005313_DUrZ00Vv_b.jpg",
    ...
    "\"Bring me some posion Pam because I don't wish to live anymore! I'm dead inside...\" -- Malory Archer" => ["http://www.wpclipart.com/medical/symbols/poison_sign.png","Silly robit, it's 'poison' not 'posion'."], # brendon
